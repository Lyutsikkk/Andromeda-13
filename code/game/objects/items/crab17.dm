...
/obj/structure/checkoutmachine/Destroy()
	...
	priority_announce("Кредитный депозитный автомат на [get_area(src)] был уничтожен. Средства на станции перестали утекать!", sender_override = "Протокол CRAB-17")
...
/obj/effect/dumpeet_target/proc/startLaunch()
	...
	priority_announce("Мыльный пузырь космокоинов лопнул! Доберитесь до кредитного автомата в [get_area(src)] и снимите деньги, пока не потеряли все свои средства!", sender_override = "Протокол CRAB-17")
