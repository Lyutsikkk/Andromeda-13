...
/datum/objective/assassinate/update_explanation_text()
	..()
	if(target?.current)
		explanation_text = "Убейте [target.name], [!target_role_type ? target.assigned_role.title : english_list(target.get_special_roles())] ОДИН РАЗ." // BUBBER EDIT ADDITION - Add ONCE
	else
...
/datum/objective/mutiny/update_explanation_text()
	..()
	if(target?.current)
		explanation_text = "Убейте или отправьте в изгнание [target.name], [!target_role_type ? target.assigned_role.title : english_list(target.get_special_roles())]."
	else
		explanation_text = "Свободная задача."
...
/datum/objective/maroon/update_explanation_text()
	if(target?.current)
		explanation_text = "Не дайте [target.name], [!target_role_type ? target.assigned_role.title : english_list(target.get_special_roles())], from escaping alive."
	else
		explanation_text = "Свободная задача."
...
/datum/objective/debrain/update_explanation_text()
	..()
	if(target?.current)
		explanation_text = "Украдите мозг [target.name], [!target_role_type ? target.assigned_role.title : english_list(target.get_special_roles())]."
	else
		explanation_text = "Свободная задача."
...
/datum/objective/protect/update_explanation_text()
	..()
	if(target?.current)
		explanation_text = "Защитите [target.name], [!target_role_type ? target.assigned_role.title : english_list(target.get_special_roles())]."
	else
		explanation_text = "Свободная задача."
...
/datum/objective/jailbreak/update_explanation_text()
	..()
	if(target?.current)
		explanation_text = "Удостоверьтесь, что [target.name], [!target_role_type ? target.assigned_role.title : english_list(target.get_special_roles())] сбежит живым и вне заключения."
	else
		explanation_text = "Свободная задача."
...
/datum/objective/jailbreak/detain/update_explanation_text()
	..()
	if(target?.current)
		explanation_text = "Удостоверьтесь, что [target.name], [!target_role_type ? target.assigned_role.title : english_list(target.get_special_roles())], доставлен на ЦК живым и в заключении."
	else
		explanation_text = "Свободная задача."
