...
/mob/eye/blob/process()
	if(!blob_core)
		...
		priority_announce("Биологическая опасность достигла критического значения. Потеря станции неминуема.", "Оповещение о биологической угрозе")
	...
	if(announcement_time && (world.time >= announcement_time || blobs_legit.len >= announcement_size) && !has_announced)
		priority_announce("Подтверждена вспышка биологической опасности пятого уровня на борту [station_name()]. Весь персонал должен сдержать вспышку.", "Оповещение о биологической угрозе", ANNOUNCER_OUTBREAK5)
		has_announced = TRUE
