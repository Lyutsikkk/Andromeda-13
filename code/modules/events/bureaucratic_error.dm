...
/datum/round_event/bureaucratic_error/announce(fake)
	priority_announce("Недавняя бюрократическая ошибка может привести к нехватке персонала в одних отделах и избыточному штатному в других.", "Предупреждение о бюрократических ошибках", ANNOUNCER_BUREAUCRATIC_ERROR) // SPLURT EDIT - ORIGINAL: priority_announce("A recent bureaucratic error in the Organic Resources Department may result in personnel shortages in some departments and redundant staffing in others.", "Paperwork Mishap Alert")
