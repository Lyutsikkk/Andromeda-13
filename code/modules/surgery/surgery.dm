...
/obj/item/disk/surgery
	name = "Диск с процедурами хирургии"
	desc = "Диск, содержащий расширенные хирургические процедуры, должен быть загружен в операционную консоль."
	icon_state = "datadisk1"
	custom_materials = list(/datum/material/iron=SMALL_MATERIAL_AMOUNT * 3, /datum/material/glass=SMALL_MATERIAL_AMOUNT)
	var/list/surgeries

/obj/item/disk/surgery/debug
	name = "Дебаг с процедурами хирургии"
	desc = "Диск, содержащий все существующие хирургические процедуры."
	icon_state = "datadisk1"
	custom_materials = list(/datum/material/iron=SMALL_MATERIAL_AMOUNT * 3, /datum/material/glass=SMALL_MATERIAL_AMOUNT)
