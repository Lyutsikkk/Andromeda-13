...
/obj/item/bodypart/proc/get_limb_icon(dropped)
	...
	if(dropped && dmg_overlay_type)
		if(brutestate)
			. += image(colored_blood_icon('icons/mob/effects/dam_mob.dmi'), "[dmg_overlay_type]_[body_zone]_[brutestate]0", -DAMAGE_LAYER) // SPLURT EDIT - Colored Blood
