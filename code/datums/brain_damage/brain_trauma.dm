...
/datum/brain_trauma
	var/name = "Травма головного мозга"
	var/desc = "Травма, вызвавшая повреждение мозга, в результате которой у пациента возникают проблемы."
...
/datum/brain_trauma/Destroy()
	...
	if(owner)
		log_game("[key_name_and_tag(owner)] получил следующую черепно-мозговую травму: [type]")
		on_lose()
		owner = null
	return ..()
