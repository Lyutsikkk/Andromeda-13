...
/datum/brain_trauma/magic/lumiphobia
	name = "Люмифобия"
	desc = "У пациента необъяснимая негативная реакция на свет."
	scan_desc = "повышенная чувствительность к свету"
...
/datum/brain_trauma/magic/poltergeist
	name = "Полтергейст"
	desc = "Пациент, похоже, стал мишенью для агрессивной невидимой сущности."
	scan_desc = "паранормальная активность"
	gain_text = span_warning("Вы чувствуете рядом с собой ненавистное присутствие.")
...
/datum/brain_trauma/magic/stalker
	name = "Преследующий фантом"
	desc = "Пациента преследует фантом, который может видеть только он."
	scan_desc = "экстрасенсорная паранойя"
	gain_text = span_warning("Вы чувствуете, что что-то хочет вас убить...")
	lose_text = span_notice("Вы больше не чувствуете глаз на своей спине.")
...
/datum/brain_trauma/magic/stalker/on_life(seconds_per_tick, times_fired)
	...
	if(get_dist(owner, stalker) <= 1)
		...
		owner.visible_message(span_warning("[owner] разорван на части невидимыми когтями!"), span_userdanger("Призрачные когти разрывают ваше тело на части!"))
