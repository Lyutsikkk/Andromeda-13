...
#define MAPTEXT_PIXELLARI(text) {"<span style='font-family: \"Pix Cyrillic\"; font-size: 12pt; -dm-text-outline: 1px black'>[##text]</span>"} /// ADD ANDROMEDA-13: Cyrillic - наше слонярское
