...
/mob/living/carbon/human/verb/toggle_hotkey_verbs()
	set category = "OOC"
	set name = "Переключение горячих клавиш"
	set desc = "Это отключает или включает кнопки пользовательского интерфейса, которые можно использовать с помощью горячих клавиш."
