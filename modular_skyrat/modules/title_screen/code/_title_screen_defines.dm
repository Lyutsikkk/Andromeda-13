...
#define DEFAULT_TITLE_SCREEN_IMAGE 'modular_andromeda/screens_music_lobby/title_screens/dedault_title_screen.png' // SPLURT EDIT START: TITLE SCREEN - old value: 'modular_skyrat/modules/title_screen/icons/skyrat_title_screen.png'
#define DEFAULT_TITLE_LOADING_SCREEN 'modular_andromeda/screens_music_lobby/title_screens/dedault_title_loading_screen.gif'
