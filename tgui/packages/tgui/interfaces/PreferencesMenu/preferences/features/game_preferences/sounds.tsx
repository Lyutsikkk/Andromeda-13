...
export const sound_tts: FeatureChoiced = {
  ...
  category: 'ЗВУК',
  description: `
     При включении этого параметра в игре можно будет слышать звуки преобразования текста в речь.
     Если установить значение «Blips», текст в речи будет заменен на звуки всплесков, основанные на голосе.
  `,
  component: FeatureDropdownInput,
};
